...
#define FAT_EOF(fs)	((gemdos_semantics ? 0xfff : 0xff8) | FAT_EXTD(fs))
...
#define FAT_MIN_BAD(fs)	((gemdos_semantics ? 0xff0 : 0xff7) | FAT_EXTD(fs))
#define FAT_MAX_BAD(fs)	((gemdos_semantics ? 0xff7 : 0xff7) | FAT_EXTD(fs))
